...
public class Rq {
    ...
    public Rq(MemberService memberService, NotificationService notificationService, MessageSource messageSource, LocaleResolver localeResolver, NotificationService notificationService1, HttpServletRequest req, HttpServletResponse resp, HttpSession session) {
