...
public class Rq {
    ...
    public Rq(MemberService memberService, NotificationService notificationService, NotificationService notificationService1, HttpServletRequest req, HttpServletResponse resp, HttpSession session) {
