    ...
    CommandLineRunner initData(
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Member memberUser9Facebook = memberService.whenSocialLogin("FACEBOOK", "FACEBOOK__1442926289783884").getData();
                ...
                LikeablePerson likeablePersonToInstaUser3 = likeablePersonService.like(memberUser4, "insta_user3", 3).getData();
                ...
                LikeablePerson likeablePersonToInstaUser5 = likeablePersonService.like(memberUser5, "insta_user4", 2).getData();
